...
<div onpaste={handlePaste} class="flex gap-[0.5rem] w-full">
  {#each inputs as value, i}
    <input
      ...
      class="size-8 text-dark text-lg text-center border rounded-md focus:outline-dark border-dark flex-1"
      type="text"
      maxlength="1"
      bind:value={inputs[i]}
