      ...
      {Object.keys(userStats).length > 0 ? (
        <>
          ...
          <div>
            ...
            {topTenPosition > 0 && (
              <h2>
                Congratulations you are number {topTenPosition} in the Leader
                board
              </h2>
            )}
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between border-b-2 border-gray-800">
                      ...
                      <p>
                        {userStats[stat].correctAnswered}/
                        {userStats[stat].answered}
                      </p>
                    </div>
                          ...
                          return (
                            <div key={`${stat}_${categoryStat}`}>
                              ...
                              <div className="ml-3">
                                <p>
                                  total:{" "}
                                  {userStats[categoryStat][stat].answered}
                                </p>
                                <p>
                                  correct:{" "}
                                  {
        ...
        <h2>You have not answered any questions yet. <Link className="text-gray-600 hover:text-gray-800 hover:underline decoration-solid" href="/">Click here to play</Link>.</h2>
      )}
    </div>
  );
}
