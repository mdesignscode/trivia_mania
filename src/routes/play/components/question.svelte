                ...
                <section aria-label="Question answers" class="grid grid-cols-2 grid-rows-2 gap-4">
                        {#each answers as answer, i}
                                <Button
                                        ...
                                        primary={!questionStore.timers[index].userAnswer && questionStore.timers[index].state === 'ended' && answer === correctAnswer}
                                        testid={answer}
                                >
                                        {#if answerFeedback[i]}
                                                <span data-testid={`feedback-${answer === correctAnswer ? 'correct' : 'incorrect'}-${i}`}>
