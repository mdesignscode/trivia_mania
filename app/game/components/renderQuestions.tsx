...
export default function RenderQuestions({
  ...
  return (
    ...
    >
      {isNaN(questionIndex) ? (
        <div className="col gap-2 mt-6 text-2xl" data-testid="all-questions-answered-container">
        ...
        <div className="col justify-center items-center gap-4 max-w-3xl mx-8 h-full" data-testid="render-questions-container">
